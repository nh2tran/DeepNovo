...
RESOLUTION_HALF = RESOLUTION // 2 # 5
MZ_MAX = 3000.0
MZ_SIZE = int(MZ_MAX * RESOLUTION) # 30k
...
PRECURSOR_MASS_PRECISION_TOLERANCE = 0.01 # Da
...
encoding_cnn_size = 4 * (RESOLUTION//10) # not used
...
train_stack_size = 5000
valid_stack_size = 9000
test_stack_size = 12000
...
#~ decode_test_file = "data/pseudomonas.PXD004560/peaks.db.10k.mgf"
